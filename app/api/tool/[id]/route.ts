...
// (cross-origin CDN blocks canvas reads). The Digizuite "format" id controls
// resolution: 50388 = 280px, 50384 = 800px, 50383 = 1600px. Default to 800
// (crisp on cards, light enough); the product hero requests 1600.
