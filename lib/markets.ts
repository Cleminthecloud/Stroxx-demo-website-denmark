...
export const markets: Market[] = [
  ...
  { _id: 'market-de', name: 'Germany', code: 'de', languages: ['de'], defaultLanguage: 'de', isReference: false, active: false, dealerName: 'Meesenburg', order: 2 },
  { _id: 'market-fr', name: 'France', code: 'fr', languages: ['fr'], defaultLanguage: 'fr', isReference: false, active: false, dealerName: 'Foussier', order: 3 },
  { _id: 'market-be', name: 'Belgium', code: 'be', languages: ['nl', 'fr'], defaultLanguage: 'nl', isReference: false, active: false, dealerName: 'Lecot', order: 4 },
];
